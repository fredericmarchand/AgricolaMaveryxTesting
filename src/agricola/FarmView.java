...
public class FarmView extends JFrame{
	...
	private Label r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,r13,r14, l_totalI, l_totalPI;
	...
	l_harvest5, l_harvest6, l_tfam, l_fam, l_turn, l_cur, l_star, l_sheep, l_boar, l_cattle, l_pasture, l_viewer;
	...
	private JTextField t_wood, t_clay, t_reed, t_food, t_sheep, t_stone, t_boar, t_cattle, t_stone2, t_tfam, t_fam, t_viewer;
	private JTextField t3_wood, t3_clay, t4_wood, t4_2wood, t4_clay, t4_food, t5_reed, t5_food, t5_clay, t5_wood, p_pasture;
	...
	public FarmView(){
		...
		//	, l_fireplace2, l_hearth, l_hearth2, l_coven, l_soven, l_joinery, l_pottery, l_basket, l_well,
		//			l2_fireplace, l2_fireplace2, l2_hearth, l2_hearth2, l2_coven, l2_soven, l2_joinery, l2_pottery, l2_basket, l2_well;
  ...
  //  }
    ...
    public JTextField[] getPlayerTexts(){
    	JTextField[] alltext = {text_food, text_reed, text_wood, text_clay, text_stone, text_grain, text_vege, t_tfam, t_fam, p_sheep, p_boar, p_cattle, p_pasture};
    	return alltext;
   	}
   	
   	public Label[] getGameImprovements(){
   		Label[] allImprovements = {l_fireplace, l_fireplace2, l_hearth, l_hearth2, l_coven, l_soven, l_joinery, l_pottery, l_basket, l_well};
   		return allImprovements;
   		
   	}
   		public Label[] getPlayerImprovements(){
   		Label[] allImprovements = {l2_fireplace, l2_fireplace2, l2_hearth, l2_hearth2, l2_coven, l2_soven, l2_joinery, l2_pottery, l2_basket, l2_well};
   		return allImprovements;
   	...
   	public JTextField[] getGameTexts(){
   		JTextField[] alltext = {text_turn, t_wood, t_clay, t_reed, t_food, t_sheep, t_stone, t_boar, t_cattle, t_stone2, t_cur, t_star, t_viewer};
   		return alltext;
   	}
